...
INSERT INTO MinorCivLeaders(
		...
		SELECT  'MINOR_CIV_HANOI',			'hanoi_leadericon.dds',			'Dai Viet',						'Ly Thái To' /*Lý Thái Tổ*/,					'Emperor',			'DJSHenninger'				UNION ALL
		...
		SELECT  'MINOR_CIV_LA_VENTA',		'la_venta_leadericon.dds',		'the Olmecs',					'Tu',											'Ku',				'DJSHenninger'				UNION ALL
		...
		SELECT  'MINOR_CIV_MBANZA_KONGO',	'mbanza_kongo_leadericon.dds',	'the Ambundu Kingdoms',			'Ana Nzingha Mbande',							'Ngola',			'LastSword'					UNION ALL
		...
		SELECT  'MINOR_CIV_QUEBEC_CITY',	'quebec_city_leadericon.dds',	'Canada',						'John A. MacDonald',							'Prime Minister',	'DJSHenninger'				UNION ALL
		...
		SELECT  'MINOR_CIV_SINGAPORE',		'singapore_leadericon.dds',		'the Republic of Singapore',	'Lee Kuan Yew' /*Lǐ Guāngyào*/,					'Prime Minister',	'EmeraldRange'				UNION ALL
		...
		SELECT  'MINOR_CIV_YEREVAN',		'yerevan_leadericon.dds',		'the Kingdom of Armenia',		'Tiridates III',								'King',				'Janboruta'					UNION ALL
...
--[ALT]	SELECT  'MINOR_CIV_LA_VENTA',		'la_venta_leadericon2.dds',		'the Olmecs',					'Po Ngbe',										'Ku',				'LastSword'					UNION ALL
--[ALT]	SELECT  'MINOR_CIV_LA_VENTA',		'la_venta_leadericon3.dds',		'the Olmecs',					'U Kix Chan',									'Ku',				'Janboruta'					UNION ALL
--[ALT]	SELECT  'MINOR_CIV_LA_VENTA',		'la_venta_leadericon4.dds',		'the Olmecs',					'Po Ngbe',										'Ku',				'Leugi'						UNION ALL
...
--[ALT]	SELECT  'MINOR_CIV_MBANZA_KONGO',	'mbanza_kongo_leadericon2.dds',	'the Ambundu Kingdoms',			'Ana Nzingha Mbande',							'Ngola',			'Leugi'						UNION ALL
...
--[ALT]	SELECT  'MINOR_CIV_SINGAPORE',		'singapore_leadericon2.dds',	'the Republic of Singapore',	'Lee Kuan Yew' /*Lǐ Guāngyào*/,					'Prime Minister',	'TPangolin'					UNION ALL
--[ALT]	SELECT  'MINOR_CIV_SINGAPORE',		'singapore_leadericon3.dds',	'Singapore',					'Thomas Stamford Raffles',						'Sir',				'adan_eslavo'				UNION ALL
...
--[ALT] SELECT  'MINOR_CIV_VANCOUVER',		'vancouver_leadericon2.dds',	'Canada',						'William Lyon Mackenzie King',					'Prime Minister',	'TPangolin'					UNION ALL
...
--[ALT] SELECT  'MINOR_CIV_YEREVAN',		'yerevan_leadericon2.dds',		'the Kingdom of Armenia',		'Tigranes II',									'King',				'DarthKyofu'				UNION ALL
--[ALT] SELECT  'MINOR_CIV_YEREVAN',		'yerevan_leadericon3.dds',		'the Kingdom of Armenia',		'Tigranes II',									'King',				'Leugi'						UNION ALL
...
--[OLD] SELECT  'MINOR_CIV_LISBON',			'lisbon_leadericon.dds',		'Portugal',						'Joao II',										'King',				'Janboruta'					UNION ALL
