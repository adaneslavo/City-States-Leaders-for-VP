...
INSERT INTO MinorCivLeaders(
		...
		SELECT	'MINOR_CIV_PANAMA_CITY',	'panama_city_leadericon.dds',	'the Republic of Panama',		'Manuel Amador',				'President',		'DuskJockey and DarthKyofu'	UNION ALL
		...
		SELECT	'MINOR_CIV_RAGUSA',			'ragusa_leadericon.dds',		'the Republic of Ragusa',		'Nicolo Vito di Gozze',			'Rector',			'DMS'						UNION ALL
